...
class LineFollower:
  ...
  def pose_cb(self, msg):
    ...
    f=open("/home/robot/catkin_ws/src/final/src/data.txt","a")
    ...
    ip.pose.pose.orientation.z = -0.1
    ip.pose.pose.orientation.w = 0.1
    
    # Send the initial pose message
    self.initial_pose_pub.publish(ip)
    '''
...
def main():
  ...
  # Default values 
  plan_topic = '/PlannerNode/car_plan'
